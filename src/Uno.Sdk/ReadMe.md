...
|----------------|:---------------:|
| UnoVersion* | 6.7.0-dev.815 |
| UnoExtensionsVersion | 7.3.0-dev.100 |
| UnoToolkitVersion | 9.0.0-dev.22 |
...
| MicrosoftIdentityClientVersion | 4.86.1 |
